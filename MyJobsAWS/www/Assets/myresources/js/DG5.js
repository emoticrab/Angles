...
var oSwitchFlooding = new sap.m.Switch("Flooding_switch", {
			...
			//changes for work bundling
	         ...
	         //layoutFixed : true,
	               width : '850px',
	             columns : 6,
	              widths : ['85px', '10px', '50px','10px','50px','400px'] });
			   var oLabel_assets = new sap.ui.commons.Label({
			         text : "Have all assets been processed? ",TextDirection:"LTR"});
			   var radio_button1 = new sap.m.RadioButton({groupName:"GroupA",text:"YES"});
			   var radio_button2 = new sap.m.RadioButton({groupName:"GroupA",text:"NO"});
...
var oLayout1a = new sap.ui.layout.form.GridLayout();
         ...
         var equipment_id = new sap.m.Input("Close_Equipment", {
             type: sap.m.InputType.Input, enabled: true, liveChange: [function (event) {
        ...
        oLabel_Action_grp.setLabelFor(Action_grp); 
         ...
         var longtext = new sap.m.TextArea("Close_LongText", {
             rows: 3, width: "250px", liveChange: [function (event) {
                 Close_LongTextVal =  event.mParameters.newValue;
             }]
         })
         oCell3.addContent(longtext);//added two fields CloseStatus_label and CloseEquipment_status for CREOL
         Matrix_Close_Job_details.createRow(oLabel_longtext, "", oCell3, "", CloseStatus_label,"",CloseEquipment_status);
